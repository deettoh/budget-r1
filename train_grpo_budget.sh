...
python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.lora.adapter_path=verl_checkpoints/sft_budgetfirst/global_step_86 \
    ...
    actor_rollout_ref.actor.budget_entropy_coeff=0.01 \
    actor_rollout_ref.actor.kl_exclude_budget=true \
    actor_rollout_ref.actor.budget_ce_coeff=0.05 \
    ...
    trainer.experiment_name=treatment_budget \
    trainer.total_epochs=15 \
    trainer.total_training_steps=40 \
    trainer.default_local_dir=verl_checkpoints/treatment_budget
